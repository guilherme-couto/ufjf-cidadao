...
<main class="form-signin">
  <form action="include/signup-cidadao.inc.php" method="post">
    ...
    <div class="form-floating">
      <input type="text" name="idade" class="form-control" id="floatingInput" placeholder="Idade">
    ...
    <div class="form-floating">
      <input type="text" name="endereco" class="form-control" id="floatingInput" placeholder="Endereço">
